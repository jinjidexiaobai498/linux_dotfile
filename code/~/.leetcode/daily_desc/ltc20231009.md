...
<html>
  <head>
    <meta charset="utf-8"><script type="text/javascript">(window.NREUM||(NREUM={})).init={ajax:{deny_list:["bam.nr-data.net"]}};(window.NREUM||(NREUM={})).loader_config={licenseKey:"8d5fb92f6e",applicationID:"1100293087"};;/*! For license information please see nr-loader-rum-1.243.1.min.js.LICENSE.txt */
...
<link rel="stylesheet" href="/static/CACHE/css/output.35273db4015b.css" type="text/css">
  ...
  <body>
    ...
    <script type="text/javascript" src="/static/webpack_bundles/common-libs.2354c519c.js" ></script>
    <script type="text/javascript" src="/static/webpack_bundles/new-libs.a9a610755.js" ></script>
